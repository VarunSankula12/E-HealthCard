                    ...
                    <div class="body table-responsive">  
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <th>Parent's</th>
                                    <td><input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="parents,320000,2">3.2L</td>
                                    <td><input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="parents,420000,3">4.2L</td>
                                    <td><input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="parents,650000,5">6.5L</td>
                                   
                                    <td>
                                       <input type="submit" class="bg-warning" value="Subscribe Now">   
                                    </td>
                                </tr>
                                <tr>
                                    <th>Family</th>
                                    <td><input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="family,420000,2">4.2L</td>
                                    <td><input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="family,540000,3">5.4L</td>
                                    <td><input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="family,800000,5">8.0L</td>
                                ...
                                <tr>
                                    <th>Self</th>
                                    <td><input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="self,230000,2">2.3L</td>
                                    <td><input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="self,300000,3">3.0L</td>
                                    <td><input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="self,460000,5">4.6L</td>
