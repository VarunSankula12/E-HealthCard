...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="row mb-3">
      <div class="col-lg-7 mx-auto">
        <div class="card  bg-light">
            ...
            <div class = "container">
                <form action="OtpVerify.jsp" id="contact-form" role="form">
  ...
  <%
      ...
      String q2="SELECT mobile FROM user WHERE email='"+email+"'";
      ResultSet result=obj.displayData(q2);
      if(result.next()){
      mobile=result.getString("mobile");
      
      }
               String query="SELECT * FROM hospitaldetails WHERE name='"+name+"'";
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="form_name" type="text" name="hname" class="form-control" value="<%=name%>" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="form_date" type="text" name="date" class="form-control" placeholder="Please enter date" required="required" data-error="Date is required." readonly>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="form_treatment" type="text" name="treatment" class="form-control" >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="form_doctor">Doctor</label>
                                <input id="form_doctor" type="doctor" name="doctor" class="form-control" placeholder="Please enter your doctor *" required="required" data-error="Valid doctor is required.">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="form_name" type="text" name="amount" class="form-control" placeholder="Enter Bill Amount" >
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // Set the formatted date to the input field with id "form_date"
        document.getElementById("form_date").value = formattedDate;
    });
</script>
