...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
   <script>
        var successMessage = '${sessionScope.pending}';
        if (successMessage !== '') {
            Swal.fire({
                icon: 'error',
                title: 'Failed!',
    ...
    <script>
        var successMessage = '${sessionScope.reject}';
        if (successMessage !== '') {
            Swal.fire({
                icon: 'error',
                title: 'Failed!',
				...
				<div class="col-lg-12 d-block">
					<div class="row d-flex">
						...
						<div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right justify-content-end">
							<p class="mb-0 register-link"><a href="hospital-login.jsp" class="mr-3">Hospital</a></p>
							<!-- <a href="#">Sign In</a> -->
						</div>
					</div>
				</div>
					...
					<div class="card1 pb-5">
					  ...
					  <h1 style="text-align:center; margin:top;  color:rgba(0, 0, 0, 0.856);" >Login</h1>
						...
						<div class="row px-3 justify-content-center mt-4 mb-5 border-line" >
							<img src="images/dd.webp" class="image">
						</div>
					</div>
				</div>
				<div class="col-lg-6" >
                                    <form action="hospital-loginAction.jsp" method="POST" id="myform" onsubmit="return validateuser()" name="myform" class="contactForm">
					...
					<div class="card2 card border-0 px-4 py-5" >
					  ...
					  <div class="row mb-3" style="display:flex;flex-direction:row;justify-content:space-between">
						...
						<div class="row px-3" style="padding:10px; color:rgba(0, 0, 0, 0.856);">
							<label class="mb-1"><h6 class="mb-0 text-sm">Hospital Email</h6></label>
						...
						<div class="row mb-3 px-3" style="padding:20px">
                                                    <a href="hospital/hsptl-index.html"><button type="submit" class="btn btn-blue text-center">Login</button></a>
						</div>
						<div class="row mb-4 px-3">
							<small class="font-weight-bold">Don't have an account? <a class="text-danger" href="hospital-reg.jsp">Register</a> </small>
						</div>
					</div>
                                </form>
				</div>
