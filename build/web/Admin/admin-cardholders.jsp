...
<%
    ...
    String Profilepic="";
      String status="ACCEPTED";
        ...
        String query="SELECT u.upload_image,c.name,c.email,c.mobile,c.status FROM user u JOIN card c on u.name=c.name";
        ResultSet rs=obj.displayData(query);
        while(rs.next()){
            val=rs.getString("status");
            if(val.equalsIgnoreCase("ACCEPTED")){
...
%>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Health(For Parents)</td>
                                                    <td>
                                                        <label class="badge-sm bg-success"><%= rs.getString("status")%></label>
                                                    </td>
                                                </tr>
