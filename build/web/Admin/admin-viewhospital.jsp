...
%>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src='data:image/jpeg;base64,<%= Profilepic %>'height="50px",width="50px">
                                                    </td>
                                                    <th><%= rs.getString("name")%></th>
                                                    <td><%= rs.getString("email")%></td>
                                                    
                                                    <td><%=rs.getString("mobile")%></td>
                                                    <td>Multispecialty Hospital</td>
                                                    <td><a  class="btn btn-success" href="admin-ViewHospitalDetails.jsp?id=<%=java.net.URLEncoder.encode(rs.getString("id"),"UTF-8")%>&email=<%=java.net.URLEncoder.encode(rs.getString("email"),"UTF-8")%>">View Details</a></td>
                                                </tr>
  <%
      }
  %>                                           
