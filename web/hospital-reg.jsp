...
<div class="container-fluid px-1 px-md-5 py-5 mx-auto">
	<div class="card card0 border-0">
		<div class="row d-flex">
			<div class="col-lg-5">
				<div class="col-md-12 bg-black  d-none d-md-block mt-5">
					<img src="images/d3.jpg " alt="login form" class="img-fluid"
			...
			<div class="col-lg-7">
				<div class="card2 card border-0 px-4 px-sm-5 py-5">
					<h3 class="mb-1">Sign up </h3>
                                        ...
                                        <form action="hospital-regAction.jsp" method="POST" id="myform"onsubmit="return validateuser()" name="myform" class="contactForm" enctype="multipart/form-data">
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <label class="mb-0">
                            ...
                            <div class="col-md-6">
                                <label class="mb-0">
                                    <h6 class="mb-0 text-sm">Hospital Branch</h6>
                                </label>
                                <input type="text" name="branch" id="branch" placeholder="John Doe">
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <label class="mb-0">
                                    <h6 class="mb-0 text-sm">Hospital Email</h6>
                                </label>
                                <input type="text" name="email" id="email" placeholder="johndoe123">
                            </div>
                            <div class="col-md-6">
                                <label class="mb-0">
                                    <h6 class="mb-0 text-sm">Landline No</h6>
                                </label>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                <label class="mb-0">
                                    <h6 class="mb-0 text-sm">Hospital Image</h6>
                                </label>
