        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="javascript:voi;" class="menu-toggle">
...
<%
    String Profilepic="";
    String query="SELECT * FROM feedback f JOIN user u on f.useremail=u.email JOIN card c on f.useremail=c.email";
...
%>                                              
                                                <tr>
                                                    <td><img src='data:image/jpeg;base64,<%= Profilepic %>' class="rounded-circle" height="50px",width="50px"></td>
                                                   <td><%= rs.getString("name")%></td>
                                                   <td><%= rs.getString("ApplicationNum")%></td>
                                                   <td><%= rs.getString("hname")%></td>
                                                   <td><%= rs.getString("treatments")%></td>
                                                   <td>
                                                   <%
