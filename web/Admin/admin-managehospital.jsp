...
%>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                    <a  class="btn btn-success" href="admin-AccceptHospital.jsp?email=<%=java.net.URLEncoder.encode(email,"UTF-8")%>">Accept</a>&nbsp &nbsp
                                    <a  class="btn btn-danger" href="admin-RejectHospital.jsp?email=<%=java.net.URLEncoder.encode(email,"UTF-8")%>">Reject</a>
                             </td>
                                                </tr>
<%
    }
