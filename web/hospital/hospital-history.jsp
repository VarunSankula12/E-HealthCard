...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
			...
			<div class="card mt-5">
				<div class="body table-responsive">  
					<table class="table table-hover">
						<h3 class="text-center">Hospital's Established</h3>
						<thead>
							<tr>
 ...
 <%
            ...
            String name="";
            String q1="SELECT * FROM hospital WHERE email='"+email+"'";
            adminDao e1=new adminDao();
            ResultSet rs=e1.displayData(q1);
            if(rs.next()){
            name=rs.getString("name");
            }
            String q2="SELECT * FROM billdetails WHERE name='"+name+"'";
            ResultSet result=e1.displayData(q2);
            while(result.next()){
        %>                                                   
							<tr>
								<td><%= result.getString("name")%></td>
                                                                <td><%= result.getString("useremail")%></td>
                                                                <td><%= result.getString("doctor")%></td>
                                                                <td><%= result.getString("treatment")%></td>
                                                                <td><%= result.getString("fee")%></td>
